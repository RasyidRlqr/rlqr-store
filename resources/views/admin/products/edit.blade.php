...
<div class="container mx-auto p-4">
    <h1 class="text-2xl font-bold mb-4">✍️ Edit Nominal Top Up: {{ $product->name }}</h1>
    ...
    <form action="{{ route('products.update', $product) }}" method="POST" class="bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="price" id="price" value="{{ old('price', $product->price) }}" min="100"
                   class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="number" name="nominal" id="nominal" value="{{ old('nominal', $product->nominal) }}" min="1"
                   class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
        </div>
